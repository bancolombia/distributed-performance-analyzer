defmodule DistributedPerformanceAnalyzer.Utils.CustomTelemetry do
  ...
  def custom_telemetry_events() do
    :telemetry.attach(
      "distributed_performance_analyzer-plug-stop",
      [:distributed_performance_analyzer, :plug, :stop],
    ...
    :telemetry.attach(
      "distributed_performance_analyzer-redis-stop",
      [:redix, :pipeline, :stop],
      &handle_custom_event/4,
      nil
    )
    ...
    :telemetry.attach(
      "distributed_performance_analyzer-vm-memory",
      [:vm, :memory],
      &handle_custom_event/4,
      nil
    )
